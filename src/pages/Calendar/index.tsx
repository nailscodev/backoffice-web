...
import { updateBooking, getBookingById, getBookingsList } from "../../api/bookings";
...
const Calender = () => {
  ...
  const handleVipComboRemoval = async (editingBooking: any) => {
    try {
      ...
      const newPrice = calculatePriceWithFees(basePrice);
    ...
    onSubmit: async (values) => {
      if (isEditBooking && selectedBooking) {
        ...
        if (values.status === 'cancelled') {
          await handleVipComboRemoval(selectedBooking);
        }
